class LoginController {
  static ERROR_MESSAGES = {
    [LoginErrorCode.PHONE_REQUIRED]: 'Vui lòng nhập số điện thoại.',
    [LoginErrorCode.PHONE_INVALID]: 'Số điện thoại phải gồm 10 chữ số và bắt đầu bằng 03, 05, 07, 08 hoặc 09.',
    [LoginErrorCode.ACCOUNT_NOT_FOUND]: 'Số điện thoại này chưa được đăng ký.',
    [LoginErrorCode.PASSWORD_REQUIRED]: 'Vui lòng nhập mật khẩu.',
    [LoginErrorCode.PASSWORD_INCORRECT]: 'Mật khẩu không chính xác. Vui lòng kiểm tra và thử lại.',
    [LoginErrorCode.SESSION_WRITE_FAILED]: 'Không thể đăng nhập lúc này. Trình duyệt đang chặn lưu phiên. Vui lòng thử lại.',
    [LoginErrorCode.SESSION_ERROR]: 'Không thể đăng nhập lúc này. Vui lòng thử lại.'
  };
  ...
  _handleSubmit(event) {
    ...
    if (!result.ok) {
      ...
      } else if (result.code === LoginErrorCode.PASSWORD_INCORRECT) {
